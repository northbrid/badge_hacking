...
* REPL - Read - Eval - Print loop. The way of how we can provide interactive shell for a script language
...
* WS2812 - RGB LED with controller - can be serial chained to form individually addressable strip
...
* FTDI (1) - Future Technology Devices Incorporated, a chip manufacturer
* FTDI (2) - Generic term for USB-to-UART converter
* WCH - Nanjing QinHeng Corp., a chip manufacturer focusing on interface converters
* CH341 (1) - WCH's chip with USB-to-UART, USB-to-SPI, and USB-to-I2C interfaces
* CH341 (2) - Popular and cheap EEPROM flasher
* Nordic - Microchip manufacturer
...
Some other links related to the above technologies:
